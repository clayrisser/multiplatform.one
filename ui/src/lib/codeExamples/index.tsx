...
`,
  ...
  // ...the rest of your configuration
    ...
    output: {
      description: 'Styles extracted, logic evaluated, and a flatter tree with atomic CSS styles per-file.',
      examples: [
        {
          name: 'app.js',
...
`,
    ...
    output: {
      description: 'Reduced object and increased render performance, improved SSR with inlinable CSS per-page.',
      examples: [
        {
          name: 'app.js',
...
`,
    ...
    output: {
      description: 'Custom defined media queries output to clean CSS that runs much faster (try resizing this site).',
      examples: [
        {
          name: 'app.js',
...
@media screen and (min-width: 861px) { :root:root ._bc-_gtSm_abc1234{background-color:rgba(0,128,0,1.00);} }`,
...

  {
    name: 'Hooks',
    input: {
      description: 'Theme and media query hooks, fully typed that work the same across native and web.',
      examples: [
        {
          name: 'app.tsx',
          language: 'tsx',
...
const App = () => {
  ...
  return (
    ...
    output: {
      description: 'If all hooks are used purely for styling, the compiler will remove the hook call entirely.',
      examples: [
        {
          name: 'app.js',
