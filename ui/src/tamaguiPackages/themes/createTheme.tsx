...
const THEME_INFO = new WeakMap<any, { palette: Palette; definition: ThemeMask; cache: Map<any, any> }>();

export function createTheme<Definition extends ThemeMask, Extras extends Record<string, string> = {}>(
  palette: Palette,
...
type SubThemeKeys<ParentKeys, ChildKeys> = `${ParentKeys extends string ? ParentKeys : never}_${ChildKeys extends string
  ? ChildKeys
  : never}`;
